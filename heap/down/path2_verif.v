...
Proof.
  ...
  forward_call (Znth (2 * pos1) Hl0, Znth pos1 Hl0, 
                field_address (tarray tint Maxsize) [ArraySubsc (2 * pos1)] a0,
  ...
  forward.
  Exists (list_swap Hl0 pos1 (2 * pos1)) (2 * pos1) a0 (Vint (IntRepr (2 * pos1))) (Vint (IntRepr size0)).
  entailer!.
  2: {
    sep_apply (int_array_with_two_holes_inv a0 Hl0 pos1 (2 * pos1) (Znth (2 * pos1) Hl0) (Znth pos1 Hl0));
      [lia | lia | entailer!].
  }
  split.
  ...
  assert (Znth (2 * pos1 + 1) Hl0 <= Znth pos1 Hl0 \/ Znth (2 * pos1 + 1) Hl0 > Znth pos1 Hl0) by lia.
  destruct H0.
  {
    left.
