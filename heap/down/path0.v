...
Definition functional_correctness_statement: Prop :=
  ...
  semax Delta (PROP ((size' = (Vint (IntRepr size0))); (pos' = (Vint (IntRepr pos0))); (a' = a0); (Z.le (Z.add size0 1) Maxsize); (Z.le 1 size0); (Z.le pos0 size0); (Z.le 1 pos0); (Z.le (Z.mul 2 Maxsize) (Int.max_signed )); (Z.le 2 Maxsize); (all_int Hl))
