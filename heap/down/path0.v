...
Definition functional_correctness_statement: Prop :=
  ...
  semax Delta (PROP ((MaxHeap_p Hl (Z.add pos0 1) size0); (MaxHeap Hl (Z.sub pos0 1)); (size' = (Vint (IntRepr size0))); (pos' = (Vint (IntRepr pos0))); (Z.le size0 Maxsize); (Z.le 1 size0); (Z.le pos0 size0); (Z.le 1 pos0))
