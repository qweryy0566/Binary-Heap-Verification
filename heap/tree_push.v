...
Lemma complete_tree_push_d_same: forall (t: tree) (d1 d2: Z), 
  complete_tree_push d1 t -> complete_tree_push d2 t -> d1 = d2.
Proof.
  intros.
  revert d1 d2 H0 H.
  induction t; intros.
  ...
  + inversion H; subst.
    - inversion H0; subst.
      * specialize (IHt2 _ _ H5 H7).
        lia.
      * pose proof full_tree_complete_tree_push _ _ H7.
        replace (d2-2+1) with (d2-1) in H1 by lia.
        specialize (IHt2 _ _ H5 H1).
        lia.
    - inversion H0; subst.
      * pose proof full_tree_complete_tree_push _ _ H5.
        replace (d1-2+1) with (d1-1) in H1 by lia.
        specialize (IHt2 _ _ H1 H7).
        lia.
      * specialize (IHt1 _ _ H3 H4).
        lia.
Qed.
